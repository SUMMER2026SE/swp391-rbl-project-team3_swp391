...
export default function GlobalChatbot() {
    ...
    const [messages, setMessages] = useState([
        {
            role: "ai",
            text: "Xin chào! Mình là trợ lý AI của PrepAce 🤖. Bạn cần mình giúp gì nào?"
        },
    ]);
    ...
    // Chỉ tính toán điều kiện, KHÔNG return ở đây
    const hideChatbot =
        ...
        try {
            ...
            setMessages((prev) => [
                ...prev,
                {
                    role: "ai",
                    text:
                        "Xin lỗi, mình gặp sự cố khi xử lý (" +
    ...
    // Sau khi tất cả hook đã chạy xong mới quyết định render
    if (hideChatbot) {
        return null;
    }

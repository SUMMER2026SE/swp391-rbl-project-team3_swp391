                                ...
                                <div key={course.id} style={{
                                    ...
                                    <div>
                                        ...
                                        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                                            <span style={{
                                                padding: "5px 10px",
                                                background: course.status === "PUBLISHED" ? "#e2fbe8" : "#fff3cd",
                                                color: course.status === "PUBLISHED" ? "#1e8a3b" : "#b45309",
                                                borderRadius: "8px",
                                                fontSize: "12px",
                                                fontWeight: "600"
                                            }}>
                                    ...
                                    <div style={{ display: "flex", gap: "10px" }}>
                                        ...
                                        <button 
                                            style={{ padding: "10px 18px", background: "#fee2e2", border: "none", borderRadius: "10px", cursor: "pointer", fontWeight: "600", color: "#b91c1c" }}
